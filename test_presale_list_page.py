...
class Test1_Seller_PaZpDkTenderKatArazrabPO_fullAprovalCycle:
...
class Test1_Dir_PaZpDkTenderKatArazrabPO_fullAprovalCycle:
...
class Test2_Seller2_PaZpDkTenderKatArazrabPO_fullAprovalCycle:

    def test_create_presale(self, browser):
        link = LoginData.link
        login_page = LoginData(browser, link)
        login_page.open()  # открываем страницу
        login_page.login_seller2()
        login_page.verify_username("Mr_KSUP_Seller2")
        presale_list_page = PresalePage(browser, link)
        presale_list_page.go_to_presale_list()
        presale_list_page.should_be_clickable_create_button()
        presale_list_page.go_to_create_presale()
...
class Test1_Dir2_PaZpDkTenderKatArazrabPO_fullAprovalCycle:
