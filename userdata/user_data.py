...
class UserData:
    ...
    name_data_file = r"UnitSale\Seller\15_[АТест_Seller] ПА+ЗП+ДК, Запрос цен товаров, работ, услуг, категория C, разработка заказного ПО, Самостоятельная продажа.json"
