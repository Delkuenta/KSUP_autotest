...
class UserData:
    #name_file_for_user_data = 'Test6_tender_Seller_PaZpDk_catC_NErazrabPO.txt'
   ...
   # with codecs.open(file_path_for_user_data, 'r', encoding='utf-8') as f:
    ...
    name_presale = "t18e1_Seller_ПА_ЗапросЦен_самостПрод_катС_НЕразрабПО"  # + str(time.time())
    type_presale = "Запрос цен товаров, работ, услуг"
    customer = "РОКА \"ПАРТНЕРСТВО\""
    ...
    performer_legal = "АО \"ЛАНИТ - БИ ПИ ЭМ\""
    sale_law_type = "223-ФЗ"
    group_category = "TIE_3"
    category = "Информационная безопасность в части инфраструктуры"
    sum = 10000000
    currency = "Рубль"
    ...
    name_zp_based_on_presale = "t18e2_Seller_ЗП_ЗапросЦен_самостПрод_катС_НЕразрабПО"
    ...
    eis_price_number = "ZP/0018-AT-Price"
