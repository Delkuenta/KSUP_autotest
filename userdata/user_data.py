...
class UserData:
    ...
    name_data_file = r"SeparateSale\Seller - ДКС\2[АТест_Seller] ПА+ЗП+ДК, Коммерческое предложение, категория A, разработка заказного ПО, НЕсамостоятельная продажa.json"
